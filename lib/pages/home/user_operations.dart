...
import 'package:teknoloji_kimya_servis/pages/material_page/material_page.dart';
...
import 'package:teknoloji_kimya_servis/pages/work_code/work_code_list.dart';
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                child: _buildElement(
                                    Icons.folder, "Ürünler", context),
                                onTap: () {
                                  Navigator.pushNamed(
                                      context, "/showProductListPage");
                                },
                              ),
                            ),
                            Expanded(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                child: _buildElement(
                                    Icons.people, "Kullanıcılar", context),
                                onTap: () async {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: InkWell(
                          child: _buildElement(Icons.location_on,
                              "Kullanıcı Konumları", context),
                          onTap: () {
                            NavigatorHelper(context)
                                .goTo(UserLocationListPage());
                          },
                        ),
                      ),
                    ],
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          child: _buildElement(
                              Icons.healing, "Sağlık Raporları", context),
                          onTap: () async {
                            NavigatorHelper(context).goTo(
                              HealthReportPage(),
                            );
                      ...
                      Expanded(
                        child: InkWell(
                          child: _buildElement(
                              Icons.code, "Çalışma Kodlarım", context),
                          onTap: () {
                            NavigatorHelper(context).goTo(
                              WorkCodeListPage(),
                            );
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          child: _buildElement(
                              Icons.autorenew, "Sarf Malzemeler", context),
                          onTap: () async {
                            NavigatorHelper(context).goTo(
                              (MaterialListPage()),
                            );
