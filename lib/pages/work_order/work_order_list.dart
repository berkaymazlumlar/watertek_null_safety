...
class WorkOrderListPage extends StatefulWidget {
  WorkOrderListPage({Key key}) : super(key: key);
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                        "${state.workOrderList.data[index].userFullName}"),
                                  ],
                                ),
                                Row(
                                  children: [
                            ...
                            subtitle: Text(
                              DateHelper.getStringDateHourTR(
                                  state.workOrderList.data[index].taskDate),
                            ),
                          ),
                        ),
                      ),
