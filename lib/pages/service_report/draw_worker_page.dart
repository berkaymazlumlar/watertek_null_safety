...
class DrawWorkerPage extends StatefulWidget {
  @override
  _DrawWorkerPageState createState() => new _DrawWorkerPageState();
}

class _DrawWorkerPageState extends State<DrawWorkerPage> {
  bool _finished;
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
          title: const Text("Personel imzası"),
          actions: actions,
      ...
      body: new Center(
          ...
          child: new Container(
              height: 200, width: 200, child: new Painter(_controller))),
    );
  }
  ...
  Future<void> _show(PictureDetails picture, BuildContext context) async {
    ...
    // Provider.of<SignProvider>(context, listen: false).customerSign = _uint8List;
    Provider.of<SignProvider>(context, listen: false).workerSign = _uint8List;
