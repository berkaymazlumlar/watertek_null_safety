...
class DrawCustomerPage extends StatefulWidget {
  @override
  _DrawCustomerPageState createState() => new _DrawCustomerPageState();
}

class _DrawCustomerPageState extends State<DrawCustomerPage> {
  bool _finished;
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
          title: const Text('Müşteri imzası'),
          actions: actions,
